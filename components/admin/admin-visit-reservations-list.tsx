...
import { Calendar, Clock, CheckCircle, XCircle, AlertCircle, MapPin, User } from "lucide-react";
import Link from "next/link";

interface AdminVisitReservationsListProps {
  visitReservations: VisitReservation[];
}

export function AdminVisitReservationsList({ visitReservations }: AdminVisitReservationsListProps) {
  ...
  const handleStatusChange = (reservationId: string, newStatus: string) => {
    ...
    // For demo, this would trigger a state update or API call
  };
        ...
        <CardContent className="py-12">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              Il n'y a pas encore de demandes de visite.
            </p>
          </div>
        </CardContent>
      </Card>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-2 text-sm text-muted-foreground">
                      <div className="flex items-center gap-2">
                        ...
                        <span>
                          <strong>Utilisateur:</strong> Jean Dupont (jean.dupont@email.com)
                        </span>
                      </div>
